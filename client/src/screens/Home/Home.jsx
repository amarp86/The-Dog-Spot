...
function Home(props) {
  return (
    <div className="home-area">
      ...
      <div className="brand-statement">The Dog Spot is an online organization based in San Diego, California where we help animal shelters from the USA adopt their dog. Feel free to check out the available dogs or add a dog ready to be adopted to our site. </div>
